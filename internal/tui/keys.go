...
func (k keyMap) ShortHelp() []key.Binding {
	return []key.Binding{k.Up, k.Down, k.Enter, k.Search, k.Refresh, k.Reindex, k.Help, k.Quit}
}
...
// detail) its own footer hints instead of the dashboard's navigation keys,
